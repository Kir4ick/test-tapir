...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'integrations.new_cars' => 'string',
            'integrations.old_cars' => 'string',
            ...
            'platform.middleware.public' => 'string',
            'platform.middleware.private' => 'string',
            ...
            'platform.turbo.prefetch' => 'boolean',
            'platform.turbo.refresh-method' => 'string',
            'platform.turbo.refresh-scroll' => 'string',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./var/www/html/public/storage','integrations.new_cars',
'integrations.old_cars','logging.default','logging.deprecations.channel','logging.deprecations.trace','logging.channels.stack.driver',
...
'mail.from.name','mail.markdown.theme','mail.markdown.paths','models.*.path','models.*.namespace',
...
'models.*.only','models.*.table_prefix','models.*.lower_table_name_first','models.*.model_names','models.*.relation_name_strategy',
'models.*.with_property_constants','models.*.with_column_list','models.*.pluralize','models.*.override_pluralize_for','models.*.hidden_in_base_files',
'models.*.fillable_in_base_files','models.*.enable_return_types','platform.domain','platform.prefix','platform.middleware.public',
'platform.middleware.private','platform.guard','platform.auth','platform.index','platform.profile',
'platform.resource.stylesheets','platform.resource.scripts','platform.vite','platform.template.header','platform.template.footer',
'platform.attachment.disk','platform.attachment.generator','platform.icons.bs','platform.notifications.enabled','platform.notifications.interval',
'platform.search','platform.turbo.cache','platform.turbo.prefetch','platform.turbo.refresh-method','platform.turbo.refresh-scroll',
'platform.fallback','platform.workspace','platform.prevents_abandonment','platform.provider','queue.default',
...
'hashing.rehash_on_login','scout.driver','scout.prefix','scout.queue','scout.after_commit',
...
'scout.typesense.client-settings.healthcheck_interval_seconds','scout.typesense.client-settings.num_retries','scout.typesense.client-settings.retry_interval_seconds','scout.typesense.model-settings','ide-helper.filename',
...
'sanctum.csrf-cookie','platform.index',
'platform.search','platform.async','platform.async.listener','platform.systems.files.upload','platform.systems.files.media',
'platform.systems.files.sort','platform.systems.files.destroy','platform.systems.files.update','platform.systems.relation','platform.systems.sorting',
'platform.notifications','platform.api.notifications','platform.','platform.login','platform.login.auth',
'platform.login.lock','platform.','platform.switch.logout','platform.logout','platform.main',
'platform.profile','platform.systems.users.edit','platform.systems.users.create','platform.systems.users','platform.systems.roles.edit',
'platform.systems.roles.create','platform.systems.roles','platform.example','platform.example.fields','platform.example.advanced',
'platform.example.editors','platform.example.actions','platform.example.layouts','platform.example.grid','platform.example.charts',
'platform.example.cards','storage.local',);
        registerArgumentsSet('views', 
'welcome','blade-icon::icon','breadcrumbs::breadcrumbs','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context',
...
'platform::actions.link','platform::actions.menu','platform::actions.modal','platform::app','platform::auth',
'platform::auth.impersonation','platform::auth.lockme','platform::auth.login','platform::auth.signin','platform::components.notification',
'platform::components.popover','platform::components.stream','platform::dashboard','platform::dummy.block','platform::errors.404',
'platform::fields.attach','platform::fields.checkbox','platform::fields.code','platform::fields.cropper','platform::fields.dataRange',
'platform::fields.datetime','platform::fields.group','platform::fields.input','platform::fields.label','platform::fields.map',
'platform::fields.matrix','platform::fields.numberRange','platform::fields.password','platform::fields.picture','platform::fields.quill',
'platform::fields.radio','platform::fields.radiobutton','platform::fields.range','platform::fields.relation','platform::fields.select',
'platform::fields.simplemde','platform::fields.switch','platform::fields.textarea','platform::fields.upload','platform::fields.utm',
'platform::footer','platform::header','platform::layouts.accordion','platform::layouts.base','platform::layouts.blank',
'platform::layouts.block','platform::layouts.browsing','platform::layouts.card','platform::layouts.chart','platform::layouts.columns',
'platform::layouts.facepile','platform::layouts.filter','platform::layouts.legend','platform::layouts.listener','platform::layouts.metric',
'platform::layouts.modal','platform::layouts.pagination','platform::layouts.persona','platform::layouts.row','platform::layouts.selection',
'platform::layouts.sortable','platform::layouts.split','platform::layouts.tabMenu','platform::layouts.table','platform::layouts.tabs',
'platform::partials.alert','platform::partials.confirm','platform::partials.fields.clear','platform::partials.fields.horizontal','platform::partials.fields.matrixRow',
'platform::partials.fields.vertical','platform::partials.layouts.dt','platform::partials.layouts.filter','platform::partials.layouts.selectedTd','platform::partials.layouts.td',
'platform::partials.layouts.th','platform::partials.notification','platform::partials.notification-wrap','platform::partials.pagination','platform::partials.profile',
'platform::partials.result','platform::partials.result-compact','platform::partials.search','platform::partials.search-modal','platform::partials.state',
'platform::partials.toast','platform::partials.update-assets','platform::partials.welcome','platform::workspace.compact','platform::workspace.full',);
...
'VITE_APP_NAME','SCOUT_DRIVER','MEILISEARCH_HOST','MEILISEARCH_NO_ANALYTICS','NEW_CARS_LINK',
'OLD_CARS_LINK',);
